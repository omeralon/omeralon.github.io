	...
	var headlight;
	var spotLightC1, spotLightC2, spotLightC3;
	...
	var setLights = function(){
		...
		//Ceiling 1
		//
		spotLightC1 = createSpotlight( 0xffffff,);
		...
		//Ceiling 2
		//
		 spotLightC2 = createSpotlight( 0xffffff);
		...
		//Ceiling 3
		//
		spotLightC3 = createSpotlight( 0xffffff);
	...
	function onMouseDoubleClick( ev ) {
		...
		var elem = document.getElementById('run_text');
	...
	var animate = function (time) {
		...
		if (spotLightC3.target.position.z > 1600) { SL_RIGHT = true;}
		if (spotLightC3.target.position.z < 200) { SL_RIGHT = false;}

		if (SL_RIGHT)
		{
			//spotLightC3.target.position.z -=2;
		}
		else
		{
			//spotLightC3.target.position.z +=2;
	...
	var render = function() {
        ...
        if (!CAMERACHANGE)
        {
            ...
            camera.lookAt( 0*comptXZ,-200*comptY,400*(comptXZ+2) );
